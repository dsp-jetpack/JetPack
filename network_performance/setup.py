...
setup(
    ...
    keywords='networking deployment testing performance cluster hpc bigdata ',
    ...
    entry_points={
        'console_scripts': [
            'netvaltest=network_testing:run_netvaltest',
            'netperftest=network_testing:run_netperfest',
        ],
    },
)
