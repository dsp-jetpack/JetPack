...
anaconda_interface="CHANGEME e.g. 100.68.183.9/255.255.255.192 em3 no"
...
extern_ifaces="CHANGEME e.g. em3 em4"
...
internal_ifaces="CHANGEME e.g. em1 em2"
...
# Public API
pub_api_bond_name="CHANGEME e.g. bond1"
pub_api_boot_opts="onboot none"
...
br_pub_api_boot_opts="CHANGEME e.g. onboot static 100.68.183.12/255.255.255.192"
...
echo "bridge_iface[br-pub-api]=\"${extern_bond_name}\"" >> /tmp/ks_post_include.txt
...
python get-pip.py
#WOrkaround for https://github.com/pypa/setuptools/issues/944
