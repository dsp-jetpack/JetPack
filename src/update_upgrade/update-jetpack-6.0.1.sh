...
exec > >(tee -a $HOME/pilot/update-js6.0.log)
exec 2>&1
...
mkdir -p ~/pilot/update-lockfiles
...
update_director_packages() {
    ...
    cd ~
    [ -e ~/pilot/update-lockfiles/director-updated.lock ] && return
    ...
    sleep 5
    touch ~/pilot/update-lockfiles/director-updated.lock
...
update_overcloud_images() {
    ...
    [ -e ~/pilot/update-lockfiles/overcloud-images-updated.lock ] && return
    ...
    touch ~/pilot/update-lockfiles/overcloud-images-updated.lock
}
...
subscribe_overcloud() {
    ...
    [ -e ~/pilot/update-lockfiles/overcloud-registered.lock ] && return
    ...
    touch ~/pilot/update-lockfiles/overcloud-registered.lock
}


prepare_overcloud() {
    [ -e ~/pilot/update-lockfiles/overcloud-prepared.lock ] && return
    cd ~/pilot
    ...
    touch ~/pilot/update-lockfiles/overcloud-prepared.lock
}


update_overcloud() {
    [ -e ~/pilot/update-lockfiles/overcloud-updated.lock ] && return
