...
cp -R $HOME/pilot/powerflex/powerflex-ansible /usr/share/powerflex-ansible
cp -R $HOME/pilot/powerflex/tripleo-powerflex-run-ansible /usr/share/ansible/tripleo-powerflex-run-ansible
