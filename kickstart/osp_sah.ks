...
logvol / --fstype=ext4    --name=lv_root --vgname=vg_root --size 37701
logvol /tmp --fstype=ext4 --name=lv_tmp  --vgname=vg_root --size 12567
logvol /var --fstype=ext4 --name=lv_var  --vgname=vg_root --size 25134
logvol swap               --name=lv_swap --vgname=vg_root --size 20108

logvol /store/data --fstype=ext4 --name=data --vgname=vg_data --size 1 --grow
...
anaconda_interface="100.67.139.11/255.255.255.192 em4 no"
...
br_mgmt_boot_opts="onboot static 192.168.110.8/255.255.255.0"

# Provisioning bridge options
br_prov_boot_opts="onboot static 192.168.120.8/255.255.255.0"

# Storage bridge options
br_stor_boot_opts="onboot static 192.168.170.8/255.255.255.0"

# Public API bridge options
br_pub_api_boot_opts="onboot static 100.67.139.8/255.255.255.192"

# Private API bridge options
br_priv_api_boot_opts="onboot static 192.168.140.8/255.255.255.0"

# Provisioning Network for NTP settings
prov_network="192.168.120.0"
prov_netmask="255.255.255.0"
