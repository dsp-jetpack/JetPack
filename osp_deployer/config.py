...
class Settings():
    ...
    def __init__(self, settings_file):
        ...
        assert os.path.isfile(settings_file), settings_file + " file does not exist"
        self.conf = ConfigParser.ConfigParser()
        self.conf.read(settings_file)
        self.settings_file = settings_file

        self.cluster_settings_map = self.get_settings_section("Cluster Settings")
        ...
        self.bastion_settings_map = self.get_settings_section("Bastion Settings")
        ...
        '/pilot/ipxe/ipxe-bootimgs-20151005-1.git6847232.el7.test.noarch.rpm'
